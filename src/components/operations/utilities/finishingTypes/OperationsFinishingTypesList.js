...
import { fetchFinishingTypes } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import OperationsFinishingTypeDelete from "./OperationsFinishingTypeDelete";
import OperationsFinishingTypeEditForm from "./OperationsFinishingTypeEditForm";

class OperationsFinishingTypesList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchFinishingTypes(this.props.token);
  }
  ...
  renderEditDialogForm = () => {
    ...
    return (
      <>
        ...
        >
          <DialogContent>
            <OperationsFinishingTypeEditForm
  ...
  renderDataList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/operations/utilities/finishingtypes/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/operations/utilities/finishingtypes/delete/${params.id}`
                ),
              ]}
            />
          </strong>
    ...
    this.props.operationsFinishingTypes.map((operationsFinishingTypes) => {
      let row = {
        numbering: ++counter,
...
const mapStateToProps = (state) => {
  return {
    operationsFinishingTypes: Object.values(state.operationsFinishingType),
  };
};

export default connect(mapStateToProps, { fetchFinishingTypes })(
  OperationsFinishingTypesList
);
