...
import { fetchQualityAssuranceTypes } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import OperationsQualityAssuranceTypeDelete from "./OperationsQualityAssuranceTypeDelete";
import OperationsQualityAssuranceTypeEditForm from "./OperationsQualityAssuranceTypeEditForm";

class OperationsQualityAssuranceTypeList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchQualityAssuranceTypes(this.props.token);
  }
  ...
  renderEditDialogForm = () => {
    ...
    return (
      <>
        ...
        >
          <DialogContent>
            <OperationsQualityAssuranceTypeEditForm
  ...
  renderDataList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/operations/utilities/qualityassurancetypes/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/operations/utilities/qualityassurancetypes/delete/${params.id}`
                ),
              ]}
            />
          </strong>
    ...
    this.props.operationQualityAssuranceTypes.map(
...
const mapStateToProps = (state) => {
  return {
    operationQualityAssuranceTypes: Object.values(
      state.operationQualityAssuranceType
    ),
  };
};

export default connect(mapStateToProps, { fetchQualityAssuranceTypes })(
