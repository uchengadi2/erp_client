...
import { EDIT_OPERATIONMAINTENANCETYPE } from "../../../../actions/types";
...
function OperationsMaintenanceTypeEditForm(props) {
  const { params } = props;
    ...
    if (formValues) {
      const editForm = async () => {
        ...
        const response = await api.patch(
          `/operationmaintenancetypes/${params.id}`,
          formValues
        );
  ...
  return (
    <form id="operationsMaintenanceTypeEditForm">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
...
export default reduxForm({
  form: "operationsMaintenanceTypeEditForm",
