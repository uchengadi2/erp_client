...
import { fetchOperationProcessings } from "../../../actions";
import DataGridContainer from "../../DataGridContainer";

import OperationsProcessingsProcessingsDelete from "./OperationsProcessingsProcessingsDelete";
import OperationsProcessingsProcessingsEditForm from "./OperationsProcessingsProcessingsEditForm";

class OperationsProcessingsProcessingsList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchOperationProcessings(this.props.token);
  }
  ...
  renderDataList = () => {
    ...
    this.props.operationProcessings.map((operationProcessing) => {
      let row = {
        numbering: ++counter,
...
const mapStateToProps = (state) => {
  return { operationProcessings: Object.values(state.operationProcessing) };
};

export default connect(mapStateToProps, { fetchOperationProcessings })(
