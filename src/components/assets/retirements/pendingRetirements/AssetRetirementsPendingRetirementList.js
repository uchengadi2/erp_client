...
import AssetRetirementsPendingRetirementDelete from "./AssetRetirementsPendingRetirementDelete";
import AssetRetirementsPendingRetirementEditForm from "./AssetRetirementsPendingRetirementEditForm";

class AssetRetirementsPendingRetirementList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  renderEditDialogForm = () => {
    ...
    return (
      <>
        ...
        >
          <DialogContent>
            <AssetRetirementsPendingRetirementEditForm
  ...
  renderDeleteDialogForm = () => {
    ...
    return (
      <>
        ...
        >
          <DialogContent>
            <AssetRetirementsPendingRetirementDelete
              token={this.props.token}
              userId={this.props.userId}
              id={this.state.id}
  ...
  renderPendingAssetRerirementsList = () => {
    let rows = [];
    let counter = 0;
    const columns = [
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/assets/retirements/pendingretirements/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/assets/retirements/pendingretirements/delete/${params.id}`
                ),
              ]}
            />
          </strong>
  ...
  render() {
    return (
      <>
        ...
        {this.renderPendingAssetRerirementsList()}
        <Snackbar
...
export default connect(mapStateToProps, { fetchAssetRetirements })(
  AssetRetirementsPendingRetirementList
);
