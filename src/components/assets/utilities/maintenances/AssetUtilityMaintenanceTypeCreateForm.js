...
import { CREATE_MAINTENANCETYPE } from "../../../../actions/types";
...
function AssetUtilityMaintenanceTypeCreateForm(props) {
  ...
  const onSubmit = (formValues) => {
    ...
    if (formValues) {
      const createForm = async () => {
        api.defaults.headers.common["Authorization"] = `Bearer ${props.token}`;
        const response = await api.post(`/maintenancetypes`, formValues);
  ...
  return (
    <form id="assetUtilityMaintenanceTypeCreateForm">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
...
export default reduxForm({
  form: "assetUtilityMaintenanceTypeCreateForm",
})(AssetUtilityMaintenanceTypeCreateForm);
