...
import { fetchMaintenanceTypes } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import AssetUtilityMaintenanceTypeDelete from "./AssetUtilityMaintenanceTypeDelete";
import AssetUtilityMaintenanceTypeEditForm from "./AssetUtilityMaintenanceTypeEditForm";

class AssetUtilityMaintenanceTypeList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchMaintenanceTypes(this.props.token);
  }
  ...
  renderDepreciationTypesList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/assets/utilities/maintenancetypes/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/assets/utilities/maintenancetypes/delete/${params.id}`
                ),
              ]}
            />
          </strong>
    ...
    this.props.maintenanceTypes.map((maintenanceType) => {
      let row = {
        numbering: ++counter,
...
const mapStateToProps = (state) => {
  return { maintenanceTypes: Object.values(state.assetMaintenanceType) };
};
