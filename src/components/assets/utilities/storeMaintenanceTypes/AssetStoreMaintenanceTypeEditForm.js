...
import { EDIT_STOREMAINTENANCETYPE } from "../../../../actions/types";
...
function AssetStoreMaintenanceTypeEditForm(props) {
  ...
  const buttonContent = () => {
    return <React.Fragment> Update Store Maintenance Type</React.Fragment>;
  };
    ...
    if (formValues) {
      const createForm = async () => {
        ...
        const response = await api.patch(
          `/storemaintenancetypes/${props.params.id}`,
          formValues
        );
        ...
        if (response.data.status === "success") {
          ...
          props.handleSuccessfulEditSnackbar(
            `${response.data.data.data.name} Store Maintenance Type is updated successfully!!!`
          );
  ...
  return (
    <form id="assetStoreMaintenanceTypeEditForm">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
...
export default reduxForm({
  form: "assetStoreMaintenanceTypeEditForm",
