...
import { fetchStoreAssetMovementTypes } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import AssetStoreMovementTypeDelete from "./AssetStoreMovementTypeDelete";
import AssetStoreMovementTypeEditForm from "./AssetStoreMovementTypeEditForm";

class AssetStoreMovementTypesList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchStoreAssetMovementTypes(this.props.token);
  }
  ...
  renderEditDialogForm = () => {
    ...
    return (
      <>
        ...
        >
          <DialogContent>
            <AssetStoreMovementTypeEditForm
  ...
  renderStoreMovementTypesList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/assets/utilities/movementtypes/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/assets/utilities/movementtypes/delete/${params.id}`
                ),
              ]}
            />
          </strong>
    ...
    this.props.storeMovementTypes.map((storeMovementType) => {
      let row = {
        numbering: ++counter,
  ...
  render() {
    return (
      <>
        ...
        {this.renderStoreMovementTypesList()}
        <Snackbar
...
const mapStateToProps = (state) => {
  return { storeMovementTypes: Object.values(state.storeMovementType) };
};

export default connect(mapStateToProps, { fetchStoreAssetMovementTypes })(
