...
import { CREATE_SUBCLASS } from "../../../../actions/types";
...
function AssetUtilitySubclassCreateForm(props) {
  ...
  const buttonContent = () => {
    return <React.Fragment> Create Asset Subclass</React.Fragment>;
  };
  ...
  const onSubmit = (formValues) => {
    ...
    if (formValues) {
      const createForm = async () => {
        ...
        const response = await api.post(`/assetsubclasses`, formValues);
        ...
        if (response.data.status === "success") {
          ...
          props.handleSuccessfulCreateSnackbar(
            `${response.data.data.data.name} Asset Subclass Type is created successfully!!!`
          );
  ...
  return (
    <form id="assetUtilitySubclassCreateForm">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
...
export default reduxForm({
  form: "assetUtilitySubclassCreateForm",
