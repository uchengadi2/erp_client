...
import { fetchAssetSubclasses } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";
import AssetUtilitySubclassDelete from "./AssetUtilitySubclassDelete";
import AssetUtilitySubclassEditForm from "./AssetUtilitySubclassEditForm";

class AssetUtilitySubclassList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchAssetSubclasses(this.props.token);
  }
  ...
  renderTransTypesList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/assets/utilities/assetsubclasses/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/assets/utilities/assetsubclasses/delete/${params.id}`
                ),
              ]}
            />
          </strong>
    ...
    this.props.assetSubclasses.map((subclass) => {
      let row = {
        numbering: ++counter,
        id: subclass.id,
        code: subclass.code,
...
const mapStateToProps = (state) => {
  return { assetSubclasses: Object.values(state.assetSubclass) };
};

export default connect(mapStateToProps, { fetchAssetSubclasses })(
  AssetUtilitySubclassList
);
