...
import { fetchAssetTypes } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import AssetUtilityAssetTypeDelete from "./AssetUtilityAssetTypeDelete";
import AssetUtilityAssetTypeEditForm from "./AssetUtilityAssetTypeEditForm";

class AssetUtilityAssetTypeList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchAssetTypes(this.props.token);
  }
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/assets/utilities/assettypes/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/assets/utilities/assettypes/delete/${params.id}`
                ),
              ]}
            />
          </strong>
...
const mapStateToProps = (state) => {
  return { assetTypes: Object.values(state.assetType) };
};

export default connect(mapStateToProps, { fetchAssetTypes })(
  AssetUtilityAssetTypeList
);
