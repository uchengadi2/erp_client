...
import { EDIT_STOREDISPOSITIONTYPE } from "../../../../actions/types";
...
function AssetStoreDispositionTypeEditForm(props) {
  ...
  const buttonContent = () => {
    return <React.Fragment> Update Disposition Type</React.Fragment>;
  };
    ...
    if (formValues) {
      const editForm = async () => {
        ...
        const response = await api.patch(
          `/dispositiontypes/${props.params.id}`,
          formValues
        );
        ...
        if (response.data.status === "success") {
          ...
          props.handleSuccessfulEditSnackbar(
            `${response.data.data.data.name} Disposition Type is updated successfully!!!`
          );
  ...
  return (
    <form id="assetStoreDispositionTypeEditForm">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
...
export default reduxForm({
  form: "assetStoreDispositionTypeEditForm",
