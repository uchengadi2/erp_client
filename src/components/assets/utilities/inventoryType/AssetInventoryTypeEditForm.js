...
import { EDIT_ASSETINVENTORYTYPE } from "../../../../actions/types";
...
function AssetInventoryEditForm(props) {
  ...
  const buttonContent = () => {
    return <React.Fragment>Update Inventory Type</React.Fragment>;
  };
      ...
      const createForm = async () => {
        ...
        if (response.data.status === "success") {
          ...
          props.handleSuccessfulEditSnackbar(
            `${response.data.data.data.name} Inventory Type is updated successfully!!!`
          );
