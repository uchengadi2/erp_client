...
import { fetchAssetStores } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import AssetStoreAllStoresDeleteStore from "./AssetStoreAllStoresDeleteStore";
import AssetStoresAllStoresEditStoreForm from "./AssetStoresAllStoresEditStoreForm";

class AssetStoresAllStoresList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchAssetStores(this.props.token);
  }
  ...
  renderAssetStoresList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/assets/stores/allstores/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/assets/stores/allstores/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
    ...
    this.props.assetStores.map((assetStore) => {
      let row = {
        numbering: ++counter,
        id: assetStore.id,
...
const mapStateToProps = (state) => {
  return { assetStores: Object.values(state.assetStore) };
};

export default connect(mapStateToProps, { fetchAssetStores })(
  AssetStoresAllStoresList
);
