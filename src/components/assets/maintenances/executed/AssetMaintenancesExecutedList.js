...
import { fetchExecutedMaintenances } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import AssetMaintenancesExecutedDelete from "./AssetMaintenancesExecutedDelete";
import AssetMaintenancesExecutedEditForm from "./AssetMaintenancesExecutedEditForm";

class AssetMaintenancesExecutedList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchExecutedMaintenances(this.props.token);
  }
  ...
  renderDepreciationTypesList = () => {
    ...
    this.props.executedMaintenances.map((executedMaintenance) => {
      let row = {
        numbering: ++counter,
...
const mapStateToProps = (state) => {
  return { executedMaintenances: Object.values(state.executedMaintenance) };
};

export default connect(mapStateToProps, { fetchExecutedMaintenances })(
  AssetMaintenancesExecutedList
);
