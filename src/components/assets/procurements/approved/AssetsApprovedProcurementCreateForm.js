...
function AssetsApprovedProcurementCreateForm(props) {
  ...
  return (
    <form id="assetsApprovedProcurementCreateForm">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
...
export default reduxForm({
  form: "assetsApprovedProcurementCreateForm",
})(AssetsApprovedProcurementCreateForm);
