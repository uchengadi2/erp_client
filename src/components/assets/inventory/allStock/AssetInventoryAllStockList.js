...
import { fetchInventoryStocks } from "../../../../actions";
...
class AssetInventoryAllStockList extends React.Component {
  ...
  componentDidMount() {
    this.props.fetchInventoryStocks(this.props.token);
  }
  ...
  renderDepreciationTypesList = () => {
    ...
    this.props.stockInventories.map((stockInventory) => {
      let row = {
        numbering: ++counter,
        id: stockInventory.id,
        code: stockInventory.code,
        name: stockInventory.name,
...
const mapStateToProps = (state) => {
  return { stockInventories: Object.values(state.stockInventory) };
};

export default connect(mapStateToProps, { fetchInventoryStocks })(
  AssetInventoryAllStockList
);
