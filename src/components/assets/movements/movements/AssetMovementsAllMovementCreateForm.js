...
function AssetMovementsAllMovementCreateForm(props) {
  ...
  const buttonContent = () => {
    return <React.Fragment> Move Stock</React.Fragment>;
  };
      ...
      const createForm = async () => {
        ...
        if (response.data.status === "success") {
          ...
          props.handleSuccessfulCreateSnackbar(
            `${response.data.data.data.movementRefNumber} Stock Movement is added successfully!!!`
          );
  ...
  return (
    <form id="assetMovementsAllMovementCreateForm">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
...
export default reduxForm({
  form: "assetMovementsAllMovementCreateForm",
})(AssetMovementsAllMovementCreateForm);
