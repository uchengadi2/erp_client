...
import { CREATE_STOCK } from "../../../../actions/types";
...
function AssetsStockCreateForm(props) {
  ...
  const [assetBatch, setAssetBatch] = useState();
  ...
  const [glSubLedger, setGlSubledger] = useState();
      ...
      <Box>
        <FormControl variant="outlined">
          ...
          <Select
            ...
            label="Asset Set"
            style={{ width: 250, marginTop: 10, marginLeft: 0, height: 38 }}
            //{...input}
          >
            {/* <MenuItem value="tangible">Tangible Asset</MenuItem>
            <MenuItem value="inTangible">Intangible Asset</MenuItem> */}
      ...
      <Box>
        <FormControl variant="outlined">
          ...
          <Select
            ...
            label="Asset Batch"
            style={{ width: 260, marginTop: 10, marginLeft: 10, height: 38 }}
            //{...input}
          >
            {/* <MenuItem value="tangible">Tangible Asset</MenuItem>
            <MenuItem value="inTangible">Intangible Asset</MenuItem> */}
      ...
      <Box>
        <FormControl variant="outlined">
          ...
          <Select
            ...
            //defaultValue={schemeType}
            value={livestockPhysicalHealthOnArrival}
            // onChange={props.handleCountryChange}
      ...
      <Box>
        <FormControl variant="outlined">
          ...
          <Select
            ...
            //defaultValue={schemeType}
            value={livestockHealthStatusOnArrival}
            // onChange={props.handleCountryChange}
      ...
      <Box>
        <FormControl variant="outlined">
          ...
          <Select
            ...
            //defaultValue={schemeType}
            value={livestockPregnancyStatusOnArrival}
            // onChange={props.handleCountryChange}
  ...
  const buttonContent = () => {
    return <React.Fragment> Add Stock</React.Fragment>;
  };
  ...
  const onSubmit = (formValues) => {
    ...
    if (
      parseFloat(remainingQuantityInBatch) < parseFloat(formValues["quantity"])
    ) {
    ...
    if (formValues) {
      const createForm = async () => {
        api.defaults.headers.common["Authorization"] = `Bearer ${props.token}`;
        const response = await api.post(`/assetstocks`, formValues);
        ...
        if (response.data.status === "success") {
          ...
          //recalculate remaining asset  quantity in the batch document
          const remainingBatchQuantity =
            remainingQuantityInBatch - formValues["quantity"];
          const dataValue = {
            id: assetBatch,
            remainingQuantityInBatch: remainingBatchQuantity,
          };
          const setResponse = await api.patch(
            `/assetsetbatches/${assetBatch}`,
            dataValue
          );

          console.log("batches response:", setResponse);

          props.handleSuccessfulCreateSnackbar(
            `${response.data.data.data.name} Stock & Asset is added successfully!!!`
          );
      ...
      >
        ...
        >
          <FormLabel
            ...
            component="legend"
          >
            <Typography variant="subtitle3"> Add Stock & Asset </Typography>
          </FormLabel>
        </Grid>
        <Grid container direction="row" style={{ width: "100%" }}>
          ...
          >
            ...
            <Grid item container direction="column" style={{ width: 600 }}>
              ...
              <Grid item>{renderUniqueAssetForm()}</Grid>
