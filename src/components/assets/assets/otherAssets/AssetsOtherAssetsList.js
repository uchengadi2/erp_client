...
import { fetchOtherAssets } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import AssetsOtherAssetDelete from "./AssetsOtherAssetDelete";
import AssetsOtherAssetEditForm from "./AssetsOtherAssetEditForm";
...
class AssetsOtherAssetsList extends React.Component {
  ...
  componentDidMount() {
    this.props.fetchOtherAssets(this.props.token);
  }
  ...
  renderDepreciationTypesList = () => {
    ...
    this.props.otherAssets.map((otherAsset) => {
      let row = {
        numbering: ++counter,
        id: otherAsset.id,
        code: otherAsset.code,
...
const mapStateToProps = (state) => {
  return { otherAssets: Object.values(state.otherAsset) };
};

export default connect(mapStateToProps, { fetchOtherAssets })(
  AssetsOtherAssetsList
);
