...
import { fetchHrExitExits } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import HrExitExitDelete from "./HrExitExitDelete";
import HrExitExitEditForm from "./HrExitExitEditForm";

class HrExitExitList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchHrExitExits(this.props.token);
  }
  ...
  renderDataList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/hr/exits/exits/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <AssignmentIcon
              onClick={() => [
                ...
                history.push(`/hr/exits/exits/assign/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/hr/exits/exits/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
    ...
    this.props.hrExitExits.map((hrExitExit) => {
      let row = {
        numbering: ++counter,
        id: hrExitExit.id,
        code: hrExitExit.code,
        name: hrExitExit.name,
        description: hrExitExit.description,
      };
      rows.push(row);
    });
...
const mapStateToProps = (state) => {
  return {
    hrExitExits: Object.values(state.hrExitExit),
  };
};

export default connect(mapStateToProps, { fetchHrExitExits })(HrExitExitList);
