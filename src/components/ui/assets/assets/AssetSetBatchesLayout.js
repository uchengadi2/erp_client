...
import AssetSetBatchCreateForm from "../../../assets/assets/assetSetBatches/AssetSetBatchCreateForm";
import AssetSetBatchList from "../../../assets/assets/assetSetBatches/AssetSetBatchList";
...
function AssetSetBatchesLayout(props) {
  ...
  return (
    ...
    >
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/assets/batches/new"),
                ]}
              >
                Create Batch
              </Button>
      ...
      <Dialog
        ...
        open={open}
        onClose={() => [setOpen(false), history.push("/assets/assets/batches")]}
      >
        <DialogContent>
...
export default AssetSetBatchesLayout;
