...
import AssetInventoryCreateForm from "../../../assets/assets/inventory/AssetInventoryCreateForm";
import AssetInventoryList from "../../../assets/assets/inventory/AssetInventoryList";
...
function AssetInventoryLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/assets/inventories/new"),
                ]}
              >
                Add Inventory
              </Button>
