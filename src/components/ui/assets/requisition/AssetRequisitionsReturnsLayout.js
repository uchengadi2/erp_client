...
import AssetRequisitionReturnAssetPostRequisitionList from "../../../assets/requisitions/returnRequisition/AssetRequisitionReturnAssetPostRequisitionList";
...
function AssetRequisitionsReturnsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetRequisitionReturnAssetPostRequisitionList
            token={props.token}
            userId={props.userId}
          />
          {/* {renderDataList()} */}
...
export default AssetRequisitionsReturnsLayout;
