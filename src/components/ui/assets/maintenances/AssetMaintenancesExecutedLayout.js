...
import AssetMaintenancesExecutedList from "../../../assets/maintenances/executed/AssetMaintenancesExecutedList";
import AssetMaintenancesExecutedCreateForm from "../../../assets/maintenances/executed/AssetMaintenancesExecutedCreateForm";
...
function AssetMaintenancesExecutedLayout(props) {
  ...
  return (
    ...
    >
      ...
      >
        <DialogContent>
          <AssetMaintenancesExecutedCreateForm
            token={props.token}
            userId={props.userId}
...
export default AssetMaintenancesExecutedLayout;
