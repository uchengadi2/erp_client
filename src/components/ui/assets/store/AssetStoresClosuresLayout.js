...
import AssetStoreClosureCreateForm from "../../../assets/stores/storeClosures/AssetStoreClosureCreateForm";
import AssetStoreClosureList from "../../../assets/stores/storeClosures/AssetStoreClosureList";
...
function AssetStoresClosuresLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/stores/closures/new"),
                ]}
              >
                Close Store
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetStoreClosureList token={props.token} userId={props.userId} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetStoresClosuresLayout;
