...
import AssetStoreMaintenancesCreateForm from "../../../assets/stores/maintenances/AssetStoreMaintenancesCreateForm";
import AssetStoreMaintenancesList from "../../../assets/stores/maintenances/AssetStoreMaintenancesList";
...
function AssetStoresMaintenanceLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/stores/maintenances/new"),
                ]}
              >
...
export default AssetStoresMaintenanceLayout;
