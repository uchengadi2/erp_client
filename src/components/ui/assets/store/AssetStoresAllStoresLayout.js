...
import AssetStoresAllStoresList from "../../../assets/stores/allstores/AssetStoresAllStoresList";
import AssetStoresAllStoresCreateStoreForm from "../../../assets/stores/allstores/AssetStoresAllStoresCreateStoreForm";
...
function AssetStoresAllStoresLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/stores/allstores/new"),
                ]}
              >
                Create Store
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <AssetStoresAllStoresList token={props.token} userId={props.userId} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AssetStoresAllStoresLayout;
