...
import AssetStoreAllocationStoreSpaceCreateForm from "../../../assets/stores/allocateSpace/AssetStoreAllocationStoreSpaceCreateForm";
import AssetStoreAllocateStoreSpaceList from "../../../assets/stores/allocateSpace/AssetStoreAllocateStoreSpaceList";
...
function AssetStoresAllocateSpaceLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/stores/spaceallocations/new"),
                ]}
              >
...
export default AssetStoresAllocateSpaceLayout;
