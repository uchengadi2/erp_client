...
import AssetMovementsAllTransfersList from "../../../assets/movements/transfers/AssetMovementsAllTransfersList";
import AssetMovementsAllTransferCreateForm from "../../../assets/movements/transfers/AssetMovementsAllTransferCreateForm";
...
function AssetsMovementsAllTransferslayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/assets/movements/alltransfers/new"),
                ]}
              >
                Transfer Stock
              </Button>
...
export default AssetsMovementsAllTransferslayout;
