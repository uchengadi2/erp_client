...
import HrCompensationsStaffLoanCreateForm from "../../../hr/compensations/loans/HrCompensationsStaffLoanCreateForm";
import HrCompensationsStaffLoansList from "../../../hr/compensations/loans/HrCompensationsStaffLoansList";
...
function HrCompensationStaffLoansLayout(props) {
  ...
  return (
    ...
    >
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/hr/compensations/staffloans/new"),
                ]}
              >
                Process Staff Loans
              </Button>
      ...
      >
        <DialogContent>
          <HrCompensationsStaffLoanCreateForm
            token={props.token}
            userId={props.userId}
