...
import HrCompensationsBonusCreateForm from "../../../hr/compensations/bonuses/HrCompensationsBonusCreateForm";
import HrCompensationsBonusList from "../../../hr/compensations/bonuses/HrCompensationsBonusList";
...
function HrCompensationBonusesLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <HrCompensationsBonusList token={props.token} userId={props.userId} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      ...
      >
        <DialogContent>
          <HrCompensationsBonusCreateForm
            token={props.token}
            userId={props.userId}
