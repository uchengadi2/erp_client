...
import HrSelfServiceStaffLoanCreateForm from "../../../hr/selfService/loan/HrSelfServiceStaffLoanCreateForm";
import HrSelfServiceStaffLoanList from "../../../hr/selfService/loan/HrSelfServiceStaffLoanList";
...
function HrSelfServicesStaffLoanLayout(props) {
  ...
  return (
    ...
    >
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/hr/selfservices/staffloans/new"),
                ]}
              >
      ...
      >
        <DialogContent>
          <HrSelfServiceStaffLoanCreateForm
            token={props.token}
            userId={props.userId}
...
export default HrSelfServicesStaffLoanLayout;
