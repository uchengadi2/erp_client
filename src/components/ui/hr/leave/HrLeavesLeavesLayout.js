...
import HrLeavesLeaveCreateForm from "../../../hr/leave/leave/HrLeavesLeaveCreateForm";
import HrLeavesLeavesList from "../../../hr/leave/leave/HrLeavesLeavesList";
...
function HrLeavesLeavesLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/hr/leaves/leaves/new"),
                ]}
              >
                Process Leave
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <HrLeavesLeavesList token={props.token} userId={props.userId} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        open={open}
        onClose={() => [setOpen(false), history.push("/hr/leaves/leaves")]}
      >
        <DialogContent>
          <HrLeavesLeaveCreateForm
            token={props.token}
            userId={props.userId}
