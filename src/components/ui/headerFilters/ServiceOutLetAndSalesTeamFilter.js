...
function ServiceOutLetAndSalesTeamFilter(props) {
      ...
      <Box>
        <FormControl variant="outlined">
          ...
          <Select
            ...
            style={{ width: 250, marginLeft: 10, marginTop: 0, height: 40 }}
          >
          ...
          >
            ...
            <Grid item>
              <Field
                ...
                name="team"
                type="text"
                component={renderSelectTeamField}
                autoComplete="off"
                //style={{ marginTop: 20 }}
              />
            </Grid>
