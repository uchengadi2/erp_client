...
function SalesTasksFilter(props) {
    ...
    return (
      <Box>
        <FormControl variant="outlined">
          ...
          >
            <MenuItem value={"ownTask"}>Own Tasks</MenuItem>
            <MenuItem value={"teamTask"}>Team Task</MenuItem>
            <MenuItem value={"asssignedTask"}>Assigned Task</MenuItem>
            {/* {renderItemList()} */}
          </Select>
