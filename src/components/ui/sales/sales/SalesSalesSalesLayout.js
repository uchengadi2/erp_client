...
import SalesSalesCreateForm from "../../../sales/sales/sales/SalesSalesCreateForm";
import SalesSalesList from "../../../sales/sales/sales/SalesSalesList";
...
function SalesSalesSalesLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/sales/sales/sales/new"),
                ]}
              >
                Add Sales
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <SalesSalesList token={props.token} userId={props.userId} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        open={open}
        onClose={() => [setOpen(false), history.push("/sales/sales/sales")]}
      >
        <DialogContent>
          <SalesSalesCreateForm
            token={props.token}
            userId={props.userId}
