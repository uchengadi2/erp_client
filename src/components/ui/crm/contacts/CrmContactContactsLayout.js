...
function CrmContactContactsLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/crm/contacts/contacts/new"),
                ]}
              >
                Add Contact
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <CrmContactsContactsList token={props.token} userId={props.userId} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
        ...
        open={open}
        onClose={() => [setOpen(false), history.push("/crm/contacts/contacts")]}
      >
        <DialogContent>
          <CrmContactsContactsCreateForm
            token={props.token}
            userId={props.userId}
...
export default CrmContactContactsLayout;
