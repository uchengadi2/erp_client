...
import OperationsQualityAssuranceCreateForm from "../../../operations/qualityAssurance/OperationsQualityAssuranceCreateForm";
import OperationsQualityAssuranceList from "../../../operations/qualityAssurance/OperationsQualityAssuranceList";
...
function OperationsQualityAssuranceProcessingLayout(props) {
  ...
  return (
    ...
    >
            ...
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push(
                    "/operations/qualityassurances/qualityassurances/new"
                  ),
                ]}
              >
      ...
      >
        <DialogContent>
          <OperationsQualityAssuranceCreateForm
            token={props.token}
            userId={props.userId}
