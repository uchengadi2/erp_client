...
import OperationsMaintenanceCreateForm from "../../../operations/maintenances/OperationsMaintenanceCreateForm";
import OperationsMaintenanceList from "../../../operations/maintenances/OperationsMaintenanceList";
...
function OperationsMaintenancesMaintenancesLayout(props) {
  ...
  return (
    ...
    >
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/operations/maintenances/maintenances/new"),
                ]}
              >
                Add Maintenance
              </Button>
      ...
      >
        <DialogContent>
          <OperationsMaintenanceCreateForm
            token={props.token}
            userId={props.userId}
...
export default OperationsMaintenancesMaintenancesLayout;
