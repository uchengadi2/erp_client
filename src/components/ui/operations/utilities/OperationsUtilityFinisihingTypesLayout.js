...
import OperationsFinishingTypeCreateForm from "../../../operations/utilities/finishingTypes/OperationsFinishingTypeCreateForm";
import OperationsFinishingTypesList from "../../../operations/utilities/finishingTypes/OperationsFinishingTypesList";
...
function OperationsUtilityFinisihingTypesLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/operations/utilities/finishingtypes/new"),
                ]}
              >
