...
import OperationsMaintenanceTypeList from "../../../operations/utilities/maintenances/OperationsMaintenanceTypeList";
import OperationsMaintenenceTypeCreateForm from "../../../operations/utilities/maintenances/OperationsMaintenenceTypeCreateForm";
...
function OperationsUtilityMaintenanceTypesLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/operations/utilities/maintenancetypes/new"),
                ]}
              >
