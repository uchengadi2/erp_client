...
import OperationsQualityAssurancePhaseCreateForm from "../../../operations/utilities/qualityAssurancePhases/OperationsQualityAssurancePhaseCreateForm";
import OperationsQualityAssurancePhaseList from "../../../operations/utilities/qualityAssurancePhases/OperationsQualityAssurancePhaseList";
...
function OperationsUtilityQualityAssurancePhasesLayout(props) {
  ...
  return (
    ...
    >
            ...
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push(
                    "/operations/utilities/qualityassurancephases/new"
                  ),
                ]}
              >
      ...
      >
        <DialogContent>
          <OperationsQualityAssurancePhaseCreateForm
            token={props.token}
            userId={props.userId}
