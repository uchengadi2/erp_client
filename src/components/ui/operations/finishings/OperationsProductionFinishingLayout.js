...
import OperationsProductionFinishingCreateForm from "../../../operations/finishings/productions/OperationsProductionFinishingCreateForm";
import OperationsProductionFinishingsList from "../../../operations/finishings/productions/OperationsProductionFinishingsList";
...
function OperationsProductionFinishingLayout(props) {
            ...
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push(
                    "/operations/finishings/productionfinishings/new"
                  ),
                ]}
              >
                Add Finishing
...
export default OperationsProductionFinishingLayout;
