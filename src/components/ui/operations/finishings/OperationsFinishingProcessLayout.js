...
import OperationsFinishingCreateForm from "../../../operations/finishings/OperationsFinishingCreateForm";
import OperationsFinishingList from "../../../operations/finishings/OperationsFinishingList";
...
function OperationsFinishingProcessLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/operations/finishings/finishings/new"),
                ]}
              >
                Add Finishing
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <OperationsFinishingList token={props.token} userId={props.userId} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
