...
function OperationsOperationsOperationsLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/operations/operations/operations/new"),
                ]}
              >
                Start an Operation
              </Button>
...
export default OperationsOperationsOperationsLayout;
