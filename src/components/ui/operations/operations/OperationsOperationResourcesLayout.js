...
import ProjectsProjectsResourcesList from "../../../operations/resources/ProjectsProjectsResourcesList";
import ProjectsProjectsResourcesCreateForm from "../../../operations/resources/ProjectsProjectsResourceCreateForm";
...
function OperationsOperationResourcesLayout(props) {
  ...
  return (
    ...
    >
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/operations/operations/resources/new"),
                ]}
              >
                Add Resource
              </Button>
      ...
      >
        <DialogContent>
          <ProjectsProjectsResourcesCreateForm
            token={props.token}
            userId={props.userId}
...
export default OperationsOperationResourcesLayout;
