...
import ProjectsClosureProjectCreateForm from "../../../projects/closure/projects/ProjectsClosureProjectCreateForm";
...
function ProjectClosureProjectLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/projects/closures/projects/new"),
                ]}
              >
                Close Project
              </Button>
...
export default ProjectClosureProjectLayout;
