...
import ProjectsProjectsProjectsCreateForm from "../../../projects/projects/ProjectsProjectsProjectsCreateForm";
import ProjectsProjectsProjectsList from "../../../projects/projects/ProjectsProjectsProjectsList";
...
function ProjectsProjectsProjectsLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/projects/projects/projects/new"),
                ]}
              >
                Create Project
              </Button>
...
export default ProjectsProjectsProjectsLayout;
