...
import ProjectsPlanningTasksCreateTask from "../../../projects/plannings/tasks/ProjectsPlanningTasksCreateTask";
import ProjectsPlanningTasksList from "../../../projects/plannings/tasks/ProjectsPlanningTasksList";
...
function ProjectsPlanningsTasksLayout(props) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/projects/plannings/tasks/new"),
                ]}
              >
                Add Task
              </Button>
...
export default ProjectsPlanningsTasksLayout;
