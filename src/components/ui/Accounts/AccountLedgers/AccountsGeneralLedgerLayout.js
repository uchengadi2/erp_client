...
import GeneralLedgerAndDatesFilter from "../../headerFilters/GeneralLedgerAndDatesFilter";
...
function AccountsGeneralLedgerLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountGeneralLedgerList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountsGeneralLedgerLayout;
