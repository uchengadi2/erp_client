...
import AccountUtilityAccountTypesList from "../../../accounts/utilities/accountTypes/AccountUtilityAccountTypesList";
...
function AccountUtilityAccountTypesLayout(props) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <AccountUtilityAccountTypesList token={props.token} />
          {/* {renderDataList()} */}
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
...
export default AccountUtilityAccountTypesLayout;
