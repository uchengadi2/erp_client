...
import { fetchSalesTeams } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import SalesTeamsDelete from "./SalesTeamsDelete";
import SalesTeamsEditForm from "./SalesTeamsEditForm";
...
class SalesTeamsList extends React.Component {
  ...
  componentDidMount() {
    this.props.fetchSalesTeams(this.props.token);
  }
  ...
  renderDataList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/sales/teams/teams/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/sales/teams/teams/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
    ...
    this.props.salesTeams.map((salesTeam) => {
      let row = {
        numbering: ++counter,
        id: salesTeam.id,
        code: salesTeam.code,
...
const mapStateToProps = (state) => {
  return { salesTeams: Object.values(state.salesTeam) };
};

export default connect(mapStateToProps, { fetchSalesTeams })(SalesTeamsList);
