...
class AccountUtilityAccountTypesList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/accounts/utilities/accounttypes/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/utilities/accounttypes/cancel/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/utilities/accounttypes/assign/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/accounts/utilities/accounttypes/delete/${params.id}`
                ),
              ]}
            />
          </strong>
...
export default connect(null, { fetchOrders })(AccountUtilityAccountTypesList);
