...
import { fetchProjectResources } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import ProjectsProjectsResourceDelete from "./ProjectsProjectsResourceDelete";
import ProjectsProjectsResourceEditForm from "./ProjectsProjectsResourceEditForm";

class ProjectsProjectsResourcesList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchProjectResources(this.props.token);
  }
  ...
  renderDeleteDialogForm = () => {
    ...
    return (
      <>
        ...
        >
          <DialogContent>
            <ProjectsProjectsResourceDelete
              token={this.props.token}
              userId={this.props.userId}
              id={this.state.id}
  ...
  renderDataList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/projects/projects/resources/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/projects/projects/resources/delete/${params.id}`
                ),
              ]}
            />
          </strong>
    ...
    this.props.projectProjectResources.map((projectProjectResource) => {
      let row = {
        numbering: ++counter,
...
const mapStateToProps = (state) => {
  return {
    projectProjectResources: Object.values(state.projectProjectResource),
  };
};

export default connect(mapStateToProps, { fetchProjectResources })(
