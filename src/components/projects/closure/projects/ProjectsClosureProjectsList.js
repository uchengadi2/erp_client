...
import { fetchProjectClosures } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import ProjectsClosureProjectDelete from "./ProjectsClosureProjectDelete";
import ProjectsClosureProjectEditForm from "./ProjectsClosureProjectEditForm";

class ProjectsClosureProjectsList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchProjectClosures(this.props.token);
  }
    ...
    return (
      <>
        <Dialog
          ...
          onClose={() => [
            this.setState({ editOpen: false }),
            history.push("/projects/closures/projects"),
          ]}
        >
          <DialogContent>
            <ProjectsClosureProjectEditForm
  ...
  renderDataList = () => {
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/projects/closures/projects/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
    ...
    this.props.projectClosures.map((projectClosure) => {
      let row = {
        numbering: ++counter,
...
const mapStateToProps = (state) => {
  return {
    projectClosures: Object.values(state.projectClosure),
  };
};

export default connect(mapStateToProps, { fetchProjectClosures })(
  ProjectsClosureProjectsList
);
