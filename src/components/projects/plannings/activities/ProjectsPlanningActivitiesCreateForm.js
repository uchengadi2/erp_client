...
import { CREATE_PROJECTPLANNINGACTIVITY } from "../../../../actions/types";
...
function ProjectsPlanningActivitiesCreateForm(props) {
      ...
      const createForm = async () => {
        ...
        if (response.data.status === "success") {
          ...
          props.handleSuccessfulCreateSnackbar(
            `${response.data.data.data.activity} Activity is added successfully!!!`
          );
  ...
  return (
    <form id="projectsPlanningActivitiesCreateForm">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
...
export default reduxForm({
  form: "projectsPlanningActivitiesCreateForm",
