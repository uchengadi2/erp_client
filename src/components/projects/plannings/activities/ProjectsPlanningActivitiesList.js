...
import { fetchProjectPlanningActivities } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";

import ProjectsPlanningActivitiesDelete from "./ProjectsPlanningActivitiesDelete";
import ProjectsPlanningActivitiesEditForm from "./ProjectsPlanningActivitiesEditForm";

class ProjectsPlanningActivitiesList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchProjectPlanningActivities(this.props.token);
  }
  ...
  renderDataList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/projects/plannings/activities/edit/${params.id}`
                ),
              ]}
            />
          </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/projects/plannings/activities/delete/${params.id}`
                ),
              ]}
            />
          </strong>
    ...
    this.props.projectPlanningActivities.map((projectPlanningActivity) => {
      let row = {
        numbering: ++counter,
...
const mapStateToProps = (state) => {
  return {
    projectPlanningActivities: Object.values(state.projectPlanningActivity),
  };
};

export default connect(mapStateToProps, { fetchProjectPlanningActivities })(
  ProjectsPlanningActivitiesList
);
