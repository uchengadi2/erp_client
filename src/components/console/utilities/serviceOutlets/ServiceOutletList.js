...
import { fetchServiceOutlets } from "../../../../actions";
import DataGridContainer from "../../../DataGridContainer";
import ServiceOutletEdit from "./ServiceOutletEdit";
import ServiceOutletDelete from "./ServiceOutletDelete";
...
class ServiceOutletList extends React.Component {
  ...
  componentDidMount() {
    this.props.fetchServiceOutlets(this.props.token);
  }
  ...
  renderProductList = () => {
    ...
    const columns = [
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(
                  `/systems/utilities/serviceoutlets/edit/${params.id}`
                ),
              ]}
            />
          </strong>
      ...
      //           history.push(
      //             `/systems/utilities/serviceoutlets/blacklist/${params.id}`
      //           ),
      //         ]}
      //       />
      //     </strong>
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(
                  `/systems/utilities/serviceoutlets/delete/${params.id}`
                ),
              ]}
            />
          </strong>
    ...
    this.props.serviceOutlets.map((serviceOutlet) => {
      let row = {
        numbering: ++counter,
        id: serviceOutlet.id,
...
const mapStateToProps = (state) => {
  return { serviceOutlets: Object.values(state.serviceOutlet) };
};

export default connect(mapStateToProps, { fetchServiceOutlets })(
  ServiceOutletList
);
