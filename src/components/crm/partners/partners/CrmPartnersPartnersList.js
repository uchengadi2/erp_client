...
import CrmPartnersPartnersDelete from "./CrmPartnersPartnersDelete";
import CrmPartnersPartnersEditForm from "./CrmPartnersPartnersEditForm";

class CrmPartnersPartnersList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
    ...
    return (
      <>
        <Dialog
          ...
          onClose={() => [
            this.setState({ editOpen: false }),
            history.push("/crm/partners/partners"),
          ]}
        >
          <DialogContent>
  ...
  renderDataList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/crm/partners/partners/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/crm/partners/partners/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
    ...
    this.props.crmPartners.map((crmPartner) => {
      let row = {
        numbering: ++counter,
        id: crmPartner.id,
...
const mapStateToProps = (state) => {
  return { crmPartners: Object.values(state.crmPartner) };
};

export default connect(mapStateToProps, { fetchPartners })(
  CrmPartnersPartnersList
);
