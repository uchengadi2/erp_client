...
function CrmContactsContactsCreateForm(props) {
  ...
  const buttonContent = () => {
    return <React.Fragment> Add Contact</React.Fragment>;
  };
  ...
  const onSubmit = (formValues) => {
    ...
    if (!formValues["contactRefNumber"]) {
      formValues["contactRefNumber"] =
  ...
  return (
    <form id="crmContactsContactsCreateForm">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
...
export default reduxForm({
  form: "crmContactsContactsCreateForm",
