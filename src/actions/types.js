...
export const CREATE_GLSUBCODE = "CREATE_SUBGLCODE";
export const FETCH_GLSUBCODEs = "FETCH_SUBGLCODES";
export const FETCH_GLSUBCODE = "FETCH_SUBGLCODE";
export const DELETE_GLSUBCODE = "DELETE_SUBGLCODE";
